...
<!--[if !IE]><!--> <html lang="en"> <!--<![endif]-->
    ...
    <head>
        <meta charset="utf-8">
        <title>Gallery Layout 01 | Generosity - Charity, Fundraising & Non-Profit HTML5 Template</title>
    ...
    <body> 
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 text-center">
                        ...
                        <p class="page-breadcrumb">
                            <a href="#">Home</a> / <a href="#">Home</a> / Gallery Layout 01
                        </p>
        ...
        <section class="section-content-block section-secondary-bg">
                ...
                <div class="row section-heading-wrapper">
                    ...
                    <div class="col-md-12 col-sm-12 text-center">
                        ...
                        <p class="section-subheading">
                            Latest news and statements regarding for your bike repair by yourself 
                        </p>
                    </div> <!-- end .col-sm-10  -->                      
            ...
            <div class="container-fluid">
                ...
                <div class="row no-padding-gallery filterable-gallery">
