...
<!--[if !IE]><!--> <html lang="en"> <!--<![endif]-->
    ...
    <head>
        <meta charset="utf-8">
        <title>Element Sponsors | Generosity - Charity, Fundraising & Non-Profit HTML5 Template</title>
    ...
    <body> 
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 text-center">
                        ...
                        <p class="page-breadcrumb">
                            <a href="#">Home</a> /  Element - Sponsors
                        </p>
            ...
            <div class="container">
                ...
                <div class="row section-heading-wrapper">
                    <div class="col-lg-12 col-md-12 col-sm-12 text-center">
                        <h2 class="text-uppercase">OUR <span>SPONSORS</span></h2>   
        ...
        <!--  START LOGO LAYOUT 04 -->
        
        <section class="section-content-block section-logo-bg section-white-bg-overlay">
        ...
        <section class="section-content-block section-secondary-bg no-padding">
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="logo-layout-1 no-border-logo-layout logo-items owl-carousel" data-nav="true" data-dots="false" data-items="5">
