...
<!--[if !IE]><!--> <html lang="en"> <!--<![endif]-->
    ...
    <head>
        <meta charset="utf-8">
        <title>Events | Generosity - Charity, Fundraising & Non-Profit HTML5 Template</title>
    ...
    <body> 
        ...
        <section class="section-content-block no-bottom-padding section-gallery-block">
                ...
                <div class="event-search-box">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5 col-sm-12">
                            <input type="text" class="form-control" placeholder="Events From">
                        </div><!-- end .col-sm-5 -->
