...
<!--[if !IE]><!--> <html lang="en"> <!--<![endif]-->
    ...
    <head>
        <meta charset="utf-8">
        <title>404 | Generosity - Charity, Fundraising & Non-Profit HTML5 Template</title>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 message-container-404">
                        ...
                        <div class="search-form-404">
                            <form action="index.html" id="search-form" class="search-form" method="get">
                        ...
                        <p class="message-text-404">
                            Sorry but we could not find the page/content you are looking for. <br>Please check to make sure you've typed the URL correctly.
