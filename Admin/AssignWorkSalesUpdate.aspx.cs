...
public partial class Admin_AssignWorkSalesUpdate : System.Web.UI.Page
{
    ...
    {if (!IsPostBack)
        {
           ...
           // BindDrp();
            ...
            //{
            //   FillEnquiry_Employee(Request.QueryString["id"].ToString());
            //}
        }
    }
    ...
    {
        Admin = Request.Cookies["ngojeetart"];
        ds = getdata.getAssignWork(Request.QueryString["id"].ToString(), "", Admin["UserId"].ToString(),"");
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        {   cmd = new SqlCommand("Sp_AssignUpdate");
            ...
            cmd.Parameters.AddWithValue("@boqid", "");
            cmd.Parameters.AddWithValue("@room", DBNull.Value);
            cmd.Parameters.AddWithValue("@prod", DBNull.Value);
