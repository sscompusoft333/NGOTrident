<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="AssignWorkReportUpdate.aspx.cs" Inherits="Admin_AddEnquiry_Employee" %>
                                ...
                                <ContentTemplate>
                                    <div class="col-md-2">
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ErrorMessage="*"
                                            Font-Bold="true" ForeColor="Red" Font-Size="Large" ControlToValidate="drpRType" InitialValue="0" ValidationGroup="validsave"></asp:RequiredFieldValidator>
                                        <asp:DropDownList ID="drpRType" runat="server" class="form-control select2" OnSelectedIndexChanged="drpRType_SelectedIndexChanged" AutoPostBack="true" ></asp:DropDownList>
                                    </div>
                                    <div class="col-md-2">
                                        <label>Product</label><asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="*"
                                            Font-Bold="true" ForeColor="Red" Font-Size="Large" ControlToValidate="drpProd" InitialValue="0"  ValidationGroup="validsave"></asp:RequiredFieldValidator>
                                        <asp:DropDownList ID="drpPRod" runat="server" class="form-control select2"></asp:DropDownList>
                                    </div>
                                </ContentTemplate>
                                <Triggers>
                                    <asp:AsyncPostBackTrigger ControlID="drpRType" EventName="SelectedIndexChanged" />
                                </Triggers>
                            </asp:UpdatePanel>
                        </div>
