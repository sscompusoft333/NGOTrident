...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="Server">
    <section class="content-header" style="height: 2.5em;">
        <h1><a id="lnkAdd" runat="server" href="/Admin/SubCategoryMaster.aspx" class="btn btn-primary">Add Sub Category </a>
        </h1>
        <ol class="breadcrumb">
            <li><a href="/Admin/Dashboard.aspx"><i class="fa fa-dashboard"></i>Home</a></li>
            <li><a href="#">Master</a></li>
            <li><a href="/Admin/subcategory.aspx" class="active">Sub Category List</a></li>
        </ol>
    </section>
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th style="text-align: left;">Category
                                         ...
                                         <th style="text-align: left;">Sub Category
                                        </th>
                                        <th>
                                            ...
                                            <tr class="gradeA">
                                                ...
                                                <td style="text-align: left;">
                                                    <div class="isEditVisible" style="display: inline;">
                                                        <a href="SubCategoryMaster.aspx?id=<%#Eval("ID") %>" style="padding: 1px 6px; font-size: 11px;" class="btn btn-small btn-primary rolese" aria-label="Edit" rel="lightbox"><i class="fa fa-pencil"></i></a>
                                                    </div>
