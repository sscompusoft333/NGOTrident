<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="Pakagetype.aspx.cs" Inherits="Admin_Pakagetype" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="Server">
    <section class="content-header" style="height: 2.5em;">
        <h1><a id="lnkAdd" runat="server" href="/Admin/PackagetypeMaster.aspx" class="btn btn-primary">Add Package </a>
        </h1>
        <ol class="breadcrumb">
            <li><a href="/Admin/Dashboard.aspx"><i class="fa fa-dashboard"></i>Home</a></li>
            <li><a href="#">Master</a></li>
            <li><a href="/Admin/Package.aspx" class="active">Package List</a></li>
        </ol>
    </section>
                            ...
                            <table id="ExportTbl" class="table table-bordered display" style="width: 100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="text-align: left;">Package
                                        </th>
                                        <th>
                                ...
                                <tbody>
                                    <asp:Repeater ID="rep"  OnItemCommand="rep_ItemCommand" runat="server" >
                                        <ItemTemplate>
                                            <tr class="gradeA">
                                                <td>
                                                ...
                                                <td style="text-align: left;">
                                                    <div class="isEditVisible" style="display: inline;">
                                                        <a href="PackageMaster.aspx?id=<%#Eval("ID") %>" style="padding: 1px 6px; font-size: 11px;" class="btn btn-small btn-primary rolese" aria-label="Edit" rel="lightbox"><i class="fa fa-pencil"></i></a>
                                                    </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Footer" runat="Server">
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $.ajax({
                url: 'Package.aspx/ControlAccess',
                dataType: "json",
                type: "POST",
