...
<!--[if !IE]><!--> <html lang="en"> <!--<![endif]-->
    ...
    <head>
        <meta charset="utf-8">
        <title>Element Testimonial | Generosity - Charity, Fundraising & Non-Profit HTML5 Template</title>
    ...
    <body> 
            ...
            <div class="container">
                ...
                <div class="row section-heading-wrapper">
                    <div class="col-lg-12 col-md-12 col-sm-12 text-center">
                        <h2 class="text-uppercase">Client Feedbacks</h2>   
        ...
        <!--  START TESTIMONIAL LAYOUT 05 -->

        <section class="section-content-block section-testimonial-bg section-theme-bg-overlay" data-stellar-background-ratio="0.3">

            <div class="container">

                <div class="row">          

                    <div class="testimonial-container owl-carousel" data-nav="true" data-dots="false">

                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">

                            <div class="testimony-layout-2 text-center">
