...
<!--[if !IE]><!--> <html lang="en"> <!--<![endif]-->
    ...
    <head>
        <meta charset="utf-8">
        <title>Single Event | Generosity - Charity, Fundraising & Non-Profit HTML5 Template</title>
                        ...
                        <div class="article-event clearfix">
                            ...
                            <div class="col-sm-12">
                                ...
                                <article class="post single-post-inner">
                                    ...
                                    <div class="post-inner-featured-content">
                                        <img alt="" src="images/event_1.jpg">
                                    </div>


                                    <div class="single-post-inner-title">
                                        <h2>Communications and volunteering</h2>
                                        <p class="single-post-meta"><i class="fa fa-user"></i>&nbsp; Deborah Beck &nbsp; &nbsp; <i class="fa fa-share"></i>&nbsp; Forest, Green World</p>
                                    </div>
                            ...
                            <div class="col-sm-4">
                                ...
                                <p class="event-content-info">
                                    ...
                                    <a href="#" title="www.example.com ">http://www.example.com </a> 
                                </p>
                            </div> <!-- end .col-sm-4  -->
                            ...
                            <div class="col-sm-4">
                                ...
                                <p class="event-content-info">
                                   Green Management <br />
                                    ...
                                    <a href="#" title="info@example.com">info@example.com </a>
                                    <span class="event-sub-content-title">Website:</span>
                                    <a href="#" title="www.example.com ">http://booking.example.com </a>
                                </p>  
                            ...
                            <div class="col-sm-4">
                                ...
                                <p class="event-content-info">
                                    ...
                                    01 8745 4362 329 <br />
                                    <span class="event-sub-content-title">Website:</span>
                                    <a href="#" title="www.example.com ">http://venue.example.com </a>
                                </p>
